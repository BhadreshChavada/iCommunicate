...
public class ApiTwilioSendMessage {
    private static final String TAG = "ApiTwilioSendMessage";
    private RetroApi retroApi;
    private IResult responseInterface;
    private Context mContext;

    public ApiTwilioSendMessage(Context mContext, IResult responseInterface) {
        retroApi = ServiceGeneratorRetro.createService(RetroApi.class, mContext, false);
        this.responseInterface = responseInterface;
        this.mContext = mContext;
        KLog.setTAG("ApiTwilioSendMessage");
    }

    public void execute(SendMessageRequest sendMessageRequest) {
        if (CommonMethods.isNetworkAvailable(mContext)) {
            ...
            Call<ResponseBody> responseBodyCall = retroApi.sendMessage(sendMessageRequest);
