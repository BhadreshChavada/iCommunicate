...
public class ApiGetCallRecords {
    private static final String TAG = "ApiGetCallRecords";
    private RetroApi retroApi;
    private IResult responseInterface;
    private Context mContext;

    public ApiGetCallRecords(Context mContext, IResult responseInterface) {
    ...
    public void execute() {
        if (CommonMethods.isNetworkAvailable(mContext)) {
            ...
            Call<ResponseBody> responseBodyCall = retroApi.getCallRecord();
