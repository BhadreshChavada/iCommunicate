...
public class ApiCallDetails {
    private static final String TAG = "ApiCallDetails";
    private RetroApi retroApi;
    private IResult responseInterface;
    private Context mContext;

    public ApiCallDetails(Context mContext, IResult responseInterface) {
    ...
    public void execute(CallHistory request) {
        if (CommonMethods.isNetworkAvailable(mContext)) {
            ...
            Call<ResponseBody> responseBodyCall = retroApi.getCallHistory(request);
