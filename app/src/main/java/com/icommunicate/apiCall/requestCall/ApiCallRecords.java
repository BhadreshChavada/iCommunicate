...
public class ApiCallRecords {
    ...
    public ApiCallRecords(Context mContext, IResult responseInterface) {
    ...
    public void execute(CallRecordingRequest callRecordingRequest) {
        if (CommonMethods.isNetworkAvailable(mContext)) {
            ...
            Call<ResponseBody> responseBodyCall = retroApi.callRecording(callRecordingRequest);
