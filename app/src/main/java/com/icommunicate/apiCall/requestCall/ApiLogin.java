...
public class ApiLogin {
    ...
    public ApiLogin(Context mContext, IResult responseInterface) {
    ...
    public void execute(LoginRequest loginRequest) {
        if (CommonMethods.isNetworkAvailable(mContext)) {
            ...
            Call<ResponseBody> responseBodyCall = retroApi.login(loginRequest);
                ...
                public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                    try {
                        ...
                        if (response.code() == 200) {
                            ...
                            try {
                                responseInterface.notifySuccess(TAG, gson.fromJson(responseJson, LoginResponse.class));
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        } else {
