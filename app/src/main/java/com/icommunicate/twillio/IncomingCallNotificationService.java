...
public class IncomingCallNotificationService extends Service {
    ...
    private Notification createNotification(CallInvite callInvite, int notificationId, int channelImportance) {
        Intent intent = new Intent(this, VoiceActivityDuplicate.class);
    ...
    private void accept(CallInvite callInvite, int notificationId) {
        endForeground();
        Intent activeCallIntent = new Intent(this, VoiceActivityDuplicate.class);
    ...
    /*
     * Send the CallInvite to the VoiceActivityDuplicate. Start the activity if it is not running already.
     */
