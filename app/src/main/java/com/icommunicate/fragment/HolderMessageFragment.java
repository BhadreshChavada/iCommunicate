...
import com.icommunicate.fragment.subFragment.FragmentMessage;

public class HolderMessageFragment extends Fragment implements Navigation {
    private final static String TAG = HolderMessageFragment.class.getName();

    FrameLayout holderFrame;

    public HolderMessageFragment() {}
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getChildFragmentManager().findFragmentById(R.id.holderFrame) == null) {
            Fragment fragment = FragmentMessage.newInstance(getContext(), "Messages", 0);
