...
//                                    isSunday.setChecked(Boolean.parseBoolean(String.valueOf(Boolean.parseBoolean(String.valueOf(hoursPojo.getIsDayoff())))));
...
//                                    isMonday.setChecked(Boolean.parseBoolean(String.valueOf(hoursPojo.getIsDayoff())));
...
//                                    isWednesday.setChecked(Boolean.parseBoolean(String.valueOf(hoursPojo.getIsDayoff())));
...
//                                    isTuesday.setChecked(Boolean.parseBoolean(String.valueOf(hoursPojo.getIsDayoff())));
...
//                                    isThursday.setChecked(Boolean.parseBoolean(String.valueOf(hoursPojo.getIsDayoff())));
...
//                                    isFriday.setChecked(Boolean.parseBoolean(String.valueOf(hoursPojo.getIsDayoff())));
...
//                                    isSaturday.setChecked(Boolean.parseBoolean(String.valueOf(hoursPojo.getIsDayoff())));
