...
import com.icommunicate.fragment.subFragment.FragmentMore;

public class HolderMoreFragment extends Fragment implements Navigation {
    private final static String TAG = HolderMoreFragment.class.getName();

    FrameLayout holderFrame;

    public HolderMoreFragment() {}
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getChildFragmentManager().findFragmentById(R.id.holderFrame) == null) {
            Fragment fragment = FragmentMore.newInstance(getContext(), "More", 0);
