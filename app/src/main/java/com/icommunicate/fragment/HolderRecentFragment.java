...
import com.icommunicate.fragment.subFragment.FragmentRecent;

public class HolderRecentFragment extends Fragment implements Navigation {
    private final static String TAG = HolderRecentFragment.class.getName();

    FrameLayout holderFrame;

    public HolderRecentFragment() {}
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getChildFragmentManager().findFragmentById(R.id.holderFrame) == null) {
            Fragment fragment = FragmentRecent.newInstance(getContext(), "Recent", 0);
